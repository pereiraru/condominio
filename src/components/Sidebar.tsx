...
const menuItems = [
  ...
  { href: '/dashboard/units', label: 'Frações', icon: (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar">
      <div className="p-6">
        <h1 className="text-xl font-semibold text-white">Condomínio</h1>
        <p className="text-xs text-gray-500 mt-1">Gestão de Condomínio</p>
      </div>
